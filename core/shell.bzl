...
# define the public `shell` rule wrapper around `_shell_impl`
shell = rule(
    impl = _shell_impl,
    doc = "executes a command via a shell interpreter with optional sources, outputs, and environment variables",
    attrs = {
